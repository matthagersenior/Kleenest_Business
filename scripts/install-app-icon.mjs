...
if(!fs.statSync(target).size)throw new Error('Business app icon decode produced an empty file.');
console.log(`Installed Business app icon at ${path.relative(root,target)}.`);
