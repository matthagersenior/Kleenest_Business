...
const reviews=requireAll('app/reviews.tsx',['business_reply_review','mobile_location_review_evidence']);
...
for(const [name,source] of Object.entries({layout,home,locations,reviews,qr,comms,intel,prevention,governance,enterprise,ai,tiers,intelligenceService})){
