...
function Action({label,secondary=false,onPress}:{label:string;secondary?:boolean;onPress?:()=>void}){return <Pressable onPress={onPress} style={{backgroundColor:secondary?'#edf3ef':'#173f2d',borderRadius:999,paddingHorizontal:13,paddingVertical:10}}><Text style={{fontWeight:'900',color:secondary?'#244d39':'white'}}>{label}</Text></Pressable>}
